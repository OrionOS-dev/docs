...
* [What You Can Build](getting-started/what-you-can-build.md)

## API Reference

* [Overview](api-reference/overview.md)
* [Agents](api-reference/agents/README.md)
  * [Create Agent](api-reference/agents/create-agent.md)
  * [List Agents](api-reference/agents/list-agents.md)
  * [Get Agent](api-reference/agents/get-agent.md)
  * [Update Agent](api-reference/agents/update-agent.md)
  * [Delete Agent](api-reference/agents/delete-agent.md)
  * [Send Message](api-reference/agents/send-message.md)

## Guides

* [Customize an Agent](guides/customize-agent.md)
* [Add Multiple Agents](guides/multiple-agents.md)
* [Test a Project](guides/testing.md)
* [Deploy a Project](guides/deployment.md)
* [Create a Plugin](guides/create-plugin.md)
* [Publish a Plugin](guides/publish-plugin.md)
* [Contribute to Core](guides/contributing.md)
...
* [Character Interface](agents/character-interface.md)
* [Personality and Behavior](agents/personality-behavior.md)
