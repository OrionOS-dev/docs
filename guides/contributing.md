...
Learn how to contribute to OrionOS core development and help improve the framework.
...
git clone https://github.com/YOUR_USERNAME/orionos.git
cd orionos

# Add upstream remote
git remote add upstream https://github.com/OrionOS-dev/orionos.git
...
- **Discord**: [OrionOS Discord](https://discord.gg/orionos) - #contributors channel
...
- [GitHub Repository](https://github.com/OrionOS-dev/orionos)
